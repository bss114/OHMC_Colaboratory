...
Note: This markdown document is for a simple cross sectional analysis of metagenomic data processed using the mgs_humann_pipeline.sh slurm array job script.
