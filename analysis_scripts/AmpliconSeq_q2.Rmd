...
```{bash settings}
echo "export TemplateXLSX=/data/SequencingRuns/2024July15_NextSeq3/libraryprep_v2/NextSeq3_Tracking_2023July30.xlsx" > settings.txt #an absolute link to the location of your run template
echo "export Project=Townsend1|Controls" >> settings.txt # This would be the Sample_Project Column. Leave this as * if you want to get all samples from the sheet. Include |Controls to pull run controls as well.
echo "export ReadDir=/data/SequencingRuns/2024July15_NextSeq3/runfolder/240802_VH00221_225_AAG3CLJM5/Analysis/1/Data/fastq" >> settings.txt #an absolute directory containing your demultiplexed reads
...
echo "export NSLOTS=12" >> settings.txt  # use 18 cores for processing
source settings.txt
```
...
ReadTracking %>%
  left_join(
    read_excel(TemplateXLSX, sheet="Loading.csv", skip=1) %>% dplyr::rename(Sample_Plate=plate96, Sample_Well=well96, Volume_ul=volume)
  )
