...
echo "export Project=kovac1rep|Controls" >> settings.txt # This would be the Sample_Project Column. Leave this as * if you want to get all samples from the sheet. Include |Controls to pull run controls as well.
