...
```{bash settings}
echo "export TemplateXLSX=/data/SequencingRuns/2024May_NextSeq2/2024June17_IndexTrackingSheet_mergedindexingRuns.xlsx" > settings.txt #an absolute link to the location of your run template
...
echo "export ReadDir=/data/SequencingRuns/2024May_NextSeq2/reads/240618_VH00221_214_AAFYM7YM5/Analysis/2/Data/fastq" >> settings.txt #an absolute directory containing your demultiplexed reads
...
echo "export NSLOTS=24" >> settings.txt  # use 18 cores for processing
source settings.txt
```
